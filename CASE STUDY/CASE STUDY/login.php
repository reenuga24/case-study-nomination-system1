...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        if ($user['role'] === 'officer') {
            ...
            $err = "Unknown role for this account.";
        }
        exit;
    } else {
...
<div class="container">
  <div class="card">
    ...
    <div class="mt-3 text-center">
      <a href="register_officer.php" class="text-primary d-block mb-1">Register as Officer</a>
      <a href="register_candidate.php" class="text-primary">Register as Candidate</a>
    </div>
  </div>
</div>
</body>
